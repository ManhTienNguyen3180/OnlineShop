                                            ...
                                            <div class="table-responsive">
                                                <div class="table-wrapper">			
                                                    <div class="table-title">
                                                        <div class="row">
                                                            <div class="col-sm-10">
                                                                <h2>Tất cả <b>Bài viết</b></h2>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <div class="search-box">
                                                                    <a href="creatpost.jsp"><i class="align-middle me-2" data-feather="plus"></i> <span class="align-middle">Thêm bài viết</span></a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <table class="table table-striped" >
                                                        <thead >
                                                            <tr>
                                                                <th>ID</th>
                                                                <th style="width: 22%;text-align: center">Tên bài viết</th>
                                                                <th style="width: 20%;text-align: center">Tác giả</th>
                                                                <th style="width: 27%;text-align: center">Tóm tắt</th>

                                                                <th style="width: 22%;text-align: center">Hình ảnh</th>
                                                        ...
                                                        <tbody >
                                                            <c:forEach items="${post}" var="c">
                                                                <tr>
                                                                    <td>${c.post_id}</td>
                                                                    <td>${c.post_name}</td>
                                                                    <td style="text-align: center">${c.post_author}</td>
                                                                    <td>${c.post_stext}</td>

                                                                    <td><img src="${c.post_img}" style="width: 100%"></td>
                                                                    <td>
                                                                        <div class="mb-2" style="display: flex">
                                                                            <a href="updatepost?id=${c.post_id}"><i class="align-middle me-2" data-feather="edit" style="color: blue"></i> <span class="align-middle"></span></a>
                                                                            <a href="#" onclick="doDelete('${c.post_id}')"><i class="align-middle me-2" data-feather="trash-2" style="color: red"></i> <span class="align-middle"></span></a>
                                                                        </div>
