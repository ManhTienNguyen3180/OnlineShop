            ...
            <div class="main">
                ...
                <main class="content" >
                    <div class="container-fluid p-0" >
                        ...
                        <div class="mb-3">
                            <h1 class="h3 d-inline align-middle">Tạo mới danh mục</h1>    
                        </div>
                        <form action="creatcategory" method="post" >
                            <div class="row" >
                                <div class="col-12 col-lg-8">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Tên danh mục</h5>
                                            <input type="text" name="category_name" required="" class="form-control" placeholder="">
                                        </div>
