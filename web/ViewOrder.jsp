                                                    ...
                                                    <table class="table table-striped" >
                                                        ...
                                                        <div style="display: flex;justify-content: space-between">
                                                            <div>
                                                                ...
                                                                <h5><b>Người đặt: ${requestScope.infor.user_name}</b></h5>
                                                                <h5>Địa chỉ: ${requestScope.infor.address}</h5>
                                                                <h5>Số điện thoại: ${requestScope.infor.phone}</h5>
                                                                <h5>Thời gian đặt hàng: ${requestScope.infor.created_at}</h5>
                                                            </div>
                                                            <div style="margin-top: 30px;margin-right: 200px">
                                                                <h5>Thanh toán: ${requestScope.infor.payment}</h5>
                                                                <h5>Đơn vị vận chuyển: Giao hàng tiết kiệm</h5>
                                                            </div>
                                                        </div>   
                                                        </tfoot>
                                                    </table>
                                                    <div>
                                                        <h4 style="display: flex;justify-content: flex-end">Phí ship: 0đ</h4>
                                                        <h3 style="display: flex;justify-content: flex-end"><b>Tổng hóa đơn: <fmt:formatNumber value="${requestScope.infor.total_money}" type="currency" currencySymbol="" minFractionDigits="0"></fmt:formatNumber>đ </b></h3>            
                                                    </div>            
                                                </div>
                                            </div>        
                                        </div>     
