                                            ...
                                            <div class="table-responsive">
                                                <div class="table-wrapper">			
                                                    <div class="table-title">
                                                        <div class="row">
                                                            <div class="col-sm-10">
                                                                <h2>Tất cả <b>Danh mục sách</b></h2>
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <div class="search-box">
                                                                    <a href="creatcategory.jsp"><i class="align-middle me-2" data-feather="plus"></i> <span class="align-middle">Thêm danh mục</span></a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <table class="table table-striped" >
                                                        <thead >
                                                            <tr>
                                                                ...
                                                                <th style="width: 22%">Tên danh mục</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="mb-2">
                                                                            ...
                                                                            <a style="margin-left: 13px" href="#" onclick="doDelete('${c.cid}')"><i class="align-middle me-2" data-feather="trash-2" style="color: red"></i> <span class="align-middle"></span></a>
                                                                        </div>
