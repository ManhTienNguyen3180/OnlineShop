            ...
            <div class="main">
                ...
                <main class="content">
                    <div class="container-fluid p-0">
                        ...
                        <div class="mb-3">
                            <h1 class="h3 d-inline align-middle">Cập nhật thông tin sách</h1>    
                        </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <input type="text" name="product_name" required="" class="form-control" value="${requestScope.product.product_name}" placeholder="">
                                            <input type="hidden" name="product_id" value="${requestScope.product.product_id}">
                                            
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Tác giả</h5>
                                            <input type="text" name="author" required="" class="form-control" value="${requestScope.product.product_author}" placeholder="">    
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">NXB</h5>
                                            <input type="text" name="NXB" required="" class="form-control" value="${requestScope.product.product_nxb}" placeholder="">    
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Kích thước</h5>
                                            <input type="text" name="kichthuoc" required="" class="form-control" value="${requestScope.product.product_kichthuoc}" placeholder="">    
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Loại Bìa</h5>
                                            <input type="text" name="loaibia" required="" class="form-control" value="${requestScope.product.product_loaibia}" placeholder="">    
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Giá bán</h5>
                                            <input type="text" name="price" required="" class="form-control" value="${requestScope.product.price}" placeholder="">    
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Giá Sale</h5>
                                            <input type="text" name="priceSale" required="" class="form-control" value="${requestScope.product.priceSale}" placeholder="">    
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <select name="category_id" class="form-select mb-3">                              
                                                <c:forEach items="${requestScope.list}" var="i">
                                                    <option value="${i.cid}"  ${(product.ct.cid==i.cid)?'selected':''} >${i.cname}</option>                                 
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <img src="${requestScope.product.product_img}" style="width: 30%" alt="alt"/>
                                        </div>
                                        <div class="card-body">
                                            <div class="mb-3">
                                        ...
                                        <div class="card-header">
                                            ...
                                            <input type="number" name="sotrang" class="form-control" value="${requestScope.product.product_sotrang}" placeholder="">    
                                        </div>
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Số lượng</h5>
                                            <input type="number" name="quantity" class="form-control" value="${requestScope.product.quantity}" placeholder="">    
                                        </div>  
                                        <div class="card">
                                            <div class="card-header">
                                            ...
                                            <div class="card-body">
                                                <textarea name="script" class="form-control" rows="4">
                                                    ${requestScope.product.product_description}
                                                </textarea>
                                            </div>
                                        </div>  
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">Sản phẩm hot</h5>
                                            <c:if test="${requestScope.product.product_ishot == 1}">
                                                <input type="checkbox" name="isHot" value="1" checked="">   
                                            </c:if>
                                            <c:if test="${requestScope.product.product_ishot != 1}">
                                                <input type="checkbox" name="isHot" value="0">   
                                            </c:if> 
                                        </div>     
                                    </div>
