...
public class ChangeProfileServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String sdt_raw = request.getParameter("SDT");
        ...
        try{
            ...
            int pass = Integer.parseInt(pass_raw);
            int sdt = Integer.parseInt(sdt_raw);
            d.UpdateProfile(id, name, pass, sdt, diachi, email);
